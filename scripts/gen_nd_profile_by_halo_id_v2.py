...
parser.add_argument('--rho_cut', action='store', type=float, default=500,
                   help='Mass density in units of rho_crit below which to keep gas particles for the hot diffuse gas')
...
_05_10_band_file = '/scratch/aspadawe/data/atomdb/Data/0.5-10.0keV_emissivity_all_elements_1000bins.hdf5'
...
cal_dat_dir = '/scratch/aspadawe/data/tspec_calibration/'
...
for halo_id in args.halo_ids:
    ...
    if args.igrm_particles:
        ...
        nh_filt = pnb.filt.LowPass('nh', args.nh_cut)
        density_filt = pnb.filt.LowPass('rho', args.rho_cut*rho_crit)
        wind_filt = ~pnb.filt.HighPass('DelayTime', 0)  # Cut out hot decoupled wind particles
        total_filt = temp_filt & nh_filt & density_filt & wind_filt
